...
void ATSPawnBase::SetAbilitySystemComp_And_AttributeSet(UAbilitySystemComponent* ASC, UAttributeSet* AS)
{
	// 여기서 생성했을 경우 실행 X
...
void ATSPawnBase::SetInitAbilityActorInfo(AActor* InOwnerActor, AActor* InAvatarActor)
{
